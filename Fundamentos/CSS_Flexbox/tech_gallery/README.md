...
![Gallery Preview](images/tech-gallery.jpeg)

#### Exercício 1
- Crie um cabeçalho para sua aplicação utilizando a tag `header`. Este cabeçalho **deve** possuir 3 elementos e estes devem ser posicionados utilizando **Flexbox**. O resultado deverá ser similar à estrutura da página "Tech-Gallery". Observe os exemplos abaixo:
![Header Exemple](images/gallery-header.jpeg)
...
![Text Sextion Exemple](images/tech-gallery-text.jpeg)
...
![Gallery Cards Exemple](images/gallery-cards.jpeg)

#### Exercício 4
- Por fim, faça o posicionamento do footer/rodapé, este é o ultimo elemento necessário para que nossa aplicação fique completa. O rodapé **deverá** conter no mínimo 2 elementos. Para o exemplo, foram adicionadas imagens que redirecionam o usuário para as redes sociais.
![Gallery Footer Exemple](images/gallery-footer.jpeg)
